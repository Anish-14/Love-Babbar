...
// TC and SC both are linear in this case
...
vector<vector<int>> depthFirstSearch(int V, int E, vector<vector<int>> &edges) {
    ...
    for(int i = 0; i<V; i++){
        if(!visited[i]){
            // component banaya to handle disconnected points, disconnected graphs in the original graphs will be noted in another row.
